...
# Todos los pasos siguientes son para crear un modelo nuevo "arriba" (on top) del modelo base
...
# Como el modelo base importado no posee la capa de clasificacion, debemos agregar capas fully connected
# estas capas sí serán entrenadas
